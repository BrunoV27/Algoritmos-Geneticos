...
clear
close all
% mi sistema representa un alimentador de distribucion ITG 12
...
Ady=readmatrix('ITG12.xlsx','sheet','Grafos','Range','B3:BG60'); %Matriz de Adyacencia
tasa_falla=readmatrix('ITG12.xlsx','sheet','Datos Iniciales','Range','F7:F64'); %vector que contiene los lambda "i"
tiempo_reparo=readmatrix('ITG12.xlsx','sheet','Datos Iniciales','Range','H7:H64'); % vector que contiene los tiempo de reparo
tiempo_seccionamiento=readmatrix('ITG12.xlsx','sheet','Datos Iniciales','Range','G7:G64'); % vector que contiene los tiempo de seccionamiento
longitudes_tramos=readmatrix('ITG12.xlsx','sheet','Datos Iniciales','Range','C7:C64'); % vector que contiene las longitudes de tramos
Li=readmatrix('ITG12.xlsx','sheet','Datos Iniciales','Range','J7:J64')  % Potencia Li (kW)
pesos_tramos=readmatrix('ITG12.xlsx','sheet','Datos Iniciales','Range','K7:K64');
dispositivos=readmatrix('ITG12.xlsx','sheet','Datos Iniciales','Range','M7:M64');    %Indica los tramos con IC, SC y SF del alimentador
acoplamientos=readcell('ITG12.xlsx','sheet','Datos Iniciales','Range','N7:P64');    %Indica los puntos de acoplamientos y cantidad de acoplamientos en cada tramo
