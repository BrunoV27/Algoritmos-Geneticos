...
clear all
close all
% mi sistema representa un alimentador de distribucion ITG 3
%% Parametros de control del AG
N=3;                      %Cantidad maxima de reconectadores
Npob=20;                  %cantidad de cromosomas a ser analizado
...
Nro_max_acoples=2;        %Cantidad maxima de acoplamientos que se desea encontrar en el alimentador (Max 3)
recos=[7 14 21];          %Insertar posiciones donde ya hay reconectadores dentro de la troncal

%% Extraccion de datos del excel
Ady=readmatrix('ITG3.xlsx','sheet','Grafos','Range','B3:AN41'); %Matriz de Adyacencia
tasa_falla=readmatrix('ITG3.xlsx','sheet','Datos Iniciales','Range','F7:F45'); %vector que contiene los lambda "i"
tiempo_reparo=readmatrix('ITG3.xlsx','sheet','Datos Iniciales','Range','H7:H45'); % vector que contiene los tiempo de reparo
tiempo_seccionamiento=readmatrix('ITG3.xlsx','sheet','Datos Iniciales','Range','G7:G45'); % vector que contiene los tiempo de seccionamiento
longitudes_tramos=readmatrix('ITG3.xlsx','sheet','Datos Iniciales','Range','C7:C45'); % vector que contiene las longitudes de tramos
Li=readmatrix('ITG3.xlsx','sheet','Datos Iniciales','Range','J7:J45');  % Potencia Li (kW)
pesos_tramos=readmatrix('ITG3.xlsx','sheet','Datos Iniciales','Range','K7:K45');
dispositivos=readmatrix('ITG3.xlsx','sheet','Datos Iniciales','Range','M7:M45');    %Indica los tramos con IC, SC y SF del alimentador
acoplamientos=readcell('ITG3.xlsx','sheet','Datos Iniciales','Range','N7:P45');    %Indica los puntos de acoplamientos y cantidad de acoplamientos en cada tramo
