function [bloques, carga_en_bloques]=bloques_de_carga_1(grafo1,cromo_arbi,Ntr,cant_ramales,Li)
%% es una funcion para calcular los bloques del sistema inicial
[Npob,ntr]=size(cromo_arbi);

%Primero creamos los bloques
bloques={};
for i=1:Npob   %se mueve por cromosoma
    cromosoma=cromo_arbi(i,:);
